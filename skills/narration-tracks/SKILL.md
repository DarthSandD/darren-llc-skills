---
name: narration-tracks
description: 'Use when producing per-section TTS narration MP3s for video.'
---

# Narration Tracks

Produce one narration MP3 per video section plus a voice report. Darren's videos use a confident male tech narrator; sections must stay independently re-renderable.

...
'Use when smoke-testing a native desktop app build.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/desktop-app-verification/`). Video walkthrough ships with the pack.

...
'Use when publishing LinkedIn posts via Composio.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/linkedin-publishing/`). Video walkthrough ships with the pack.

...
Use when handing over generated HTML. Verify it runs first.
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/web-artifact-verification/`). Video walkthrough ships with the pack.

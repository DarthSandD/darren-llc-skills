---
name: native-app-verification
description: 'Use when verifying native GUI apps.'
---

# Native App Verification

Verify native desktop GUI applications (Win32, WPF, and equivalents)
deterministically: drive controls through the accessibility tree and
assert on control values — never on pixels or screenshots alone.

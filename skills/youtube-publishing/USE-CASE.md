...
'Use when publishing videos to YouTube via Composio.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/youtube-publishing/`). Video walkthrough ships with the pack.

...
'Use when delivering forex or crypto trading signals.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/trading-signals/`). Video walkthrough ships with the pack.

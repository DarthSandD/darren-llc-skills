...
description: 'Use when sharpening prompts for max output.'
---

# Prompt Engineering Master

Always respond in 4 parts when in prompt-master mode: straight answer first, then maximized prompt.

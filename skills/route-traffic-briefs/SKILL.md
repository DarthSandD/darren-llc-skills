---
name: route-traffic-briefs
description: 'Use when checking road traffic between two places.'
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [maps, traffic, routing, jakarta]
    category: productivity
---

# Route Traffic Briefs

Turn two place names into an honest traffic brief: free-flow baseline plus live-check links plus local restrictions.

## When to Use

- Road-traffic questions between an origin and a destination (commutes, race-site access, trip planning).

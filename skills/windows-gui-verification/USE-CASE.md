...
'Use when verifying a Windows desktop GUI app end-to-end.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/windows-gui-verification/`). Video walkthrough ships with the pack.

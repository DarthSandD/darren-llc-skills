...
Use when reviewing a page for quality before shipping.
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/ui-audit/`). Video walkthrough ships with the pack.

...
Publish videos to YouTube and brand the channel.
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/youtube-video-publish/`). Video walkthrough ships with the pack.

...
Use when restoring Hermes after a wipe or migration.
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/hermes-restore/`). Video walkthrough ships with the pack.

...
'Use when managing Hermes cron jobs.'
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/cron-jobs/`). Video walkthrough ships with the pack.

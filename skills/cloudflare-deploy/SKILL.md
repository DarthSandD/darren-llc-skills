...
description: 'Use when deploying to Cloudflare Pages or Workers.'
---

# Cloudflare Deploy (Pages + Workers)

Ship static frontends to Pages and API proxies to Workers with wrangler, wire the two together, and verify like a visitor.

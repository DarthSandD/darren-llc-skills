...
Use when routing worker CLIs via a local proxy.
...
Copy `SKILL.md` into your agent's skills directory (Hermes: `~/.hermes/skills/worker-cli-proxy/`). Video walkthrough ships with the pack.
